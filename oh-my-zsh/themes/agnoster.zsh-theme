...
# A Powerline-inspicyan theme for ZSH
#
# # README
#
...
# - displays yellow on cyan if profile name contains 'production' or
#   ends in '-prod'
# - displays black on green otherwise
prompt_aws() {
  [[ -z "$AWS_PROFILE" ]] && return
  case "$AWS_PROFILE" in
    *-prod|*production*) prompt_segment cyan yellow  "AWS: $AWS_PROFILE" ;;
